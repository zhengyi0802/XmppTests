package tk.munditv.xmppservice.database.models;
...
import tk.munditv.xmppservice.database.DatabaseModel;
import tk.munditv.xmppservice.database.tables.MessagesTable;

import static tk.munditv.xmppservice.database.SqLiteDatabase.getIntFromCursor;
import static tk.munditv.xmppservice.database.SqLiteDatabase.getLongFromCursor;
import static tk.munditv.xmppservice.database.SqLiteDatabase.getStringFromCursor;
